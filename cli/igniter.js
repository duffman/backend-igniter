...
var create_module_1 = require("./commands/create-module");
...
var Igniter = /** @class */ (function () {
    ...
    Igniter.prototype.showList1 = function () {
    ...
    Igniter.prototype.showList2 = function () {
        return new Promise(function (resolve, reject) {
            var list = new List({
                name: 'Scope',
    ...
    Igniter.prototype.showList = function () {
        return __awaiter(this, void 0, void 0, function () {
            var answer1, answer2, cmd;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.showList1()];
                    case 1:
                        answer1 = _a.sent();
                        return [4 /*yield*/, this.showList2()];
                    case 2:
                        answer2 = _a.sent();
                        cmd = new create_module_1.CreateModule();
