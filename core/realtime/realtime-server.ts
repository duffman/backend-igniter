...
import { RealtimeConst }    from "@core/realtime/realtime-const";
import { IRealtimeMessage } from "@core/realtime/realtime-messages";
import { RealtimeMessage }  from "@core/realtime/realtime-messages";
...
export class RealtimeServer implements IRealtimeServer {
	...
	constructor() {
		...
		Logger.logCyan("/////////////////////////////////")
		Logger.logCyan("// Realtime Server - Starting")
		Logger.logCyan("/////////////////////////////////")
	}
	...
	public listen(): void {
		...
		this.server.listen(this.port, () => {
			Logger.logCyan('Running Realtime Server on port %s', this.port);
		});
